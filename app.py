...
def main():
    ...
    # Main page content
    st.set_page_config(page_title='FinAdvisor - Your finance buddy', page_icon="	:money_mouth_face:",)
    st.title("**FinAdvisor** - _Your finance buddy_ :money_mouth_face: ")
    st.write("---")
    ...
    if option == 'Budget Calculator':
        ...
        st.write('### About')
        st.markdown('''
        *FinAdvisor* is developed by **Anvesh Dange** (AI developer, Data Scientist, Python Backend developer)

        * Github  - https://github.com/anveshdange
        * Twitter - https://twitter.com/anveshdange 
        * Instagram - https://instagram.com/anveshdange07
